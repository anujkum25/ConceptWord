...
class COCO:
    def __init__(self, annotation_file=None):
        ...
        if not annotation_file == None:
            print('[coco] loading annotations into memory...')
    ...
    def loadRes(self, resFile):
        ...
        print('[coco] Loading and preparing results...     ')
        time_t = datetime.datetime.utcnow()
        ...
        if 'caption' in anns[0]:
            ...
            for id, ann in enumerate(anns):
                ...
                ann['id'] = id
                ann['iscrowd'] = 0
        print('[coco] DONE (t=%0.2fs)'%((datetime.datetime.utcnow() - time_t).total_seconds()))
